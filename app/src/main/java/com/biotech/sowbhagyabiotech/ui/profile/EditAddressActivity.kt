...
import com.biotech.sowbhagyabiotech.databinding.ActivityEditAddressBinding
...
class EditAddressActivity : AppCompatActivity() {
    ...
    private var _binding: ActivityEditAddressBinding? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        _binding = ActivityEditAddressBinding.inflate(layoutInflater)
        ...
        securedSharedPreferenceWrapper =
            SecuredSharedPreferenceWrapper(this@EditAddressActivity, "sowbhagya")
    ...
    private fun addObservers() {
        ...
        homeViewModel.addressModelResponse.observe(this@EditAddressActivity) {
            if (it?.Status == true) {
                CommonMethods.hideProgress()
                finish()
                Toast.makeText(
                    this@EditAddressActivity, "Address updated successfully...", Toast.LENGTH_LONG
                ).show()
            } else {
                CommonMethods.hideProgress()
